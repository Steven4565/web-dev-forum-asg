...
<form action="{{route('comment.store')}}" method="post">
    ...
    <div class="flex flex-col  items-end">
        ...
        <button type="submit" class="text-primary1 font-bold bg-primary2 focus:ring-4 focus:outline-none focus:ring-primary1 rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Reply</button>
    </div>
</form>
